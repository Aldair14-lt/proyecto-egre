...
public abstract class CrudController<T, ID> {
    ...
    @GetMapping
    public List<T> listar() { return service.listar(); }
    ...
    /** Crea un registro o guarda los cambios enviados. */
    @PostMapping
    public ResponseEntity<T> guardar(@RequestBody T entity) {
        return ResponseEntity.status(HttpStatus.CREATED).body(service.guardar(entity));
    }
