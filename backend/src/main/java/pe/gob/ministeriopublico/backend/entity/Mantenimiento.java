...
/** Representa el mantenimiento realizado a un equipo. */
@Entity
@Table(name = "mantenimiento")
public class Mantenimiento {
    @Id @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "id_mantenimiento") private Integer idMantenimiento;
    @Column(name = "id_equipo", nullable = false) private Integer idEquipo;
    @Column(name = "id_tipo_mantenimiento", nullable = false) private Integer idTipoMantenimiento;
    @Column(name = "fecha_mantenimiento", nullable = false) private LocalDate fechaMantenimiento;
    @Column(name = "diagnostico") private String diagnostico;
    @Column(name = "trabajo_realizado") private String trabajoRealizado;
    @Column(name = "repuesto") private String repuesto;
    @Column(name = "responsable_mantenimiento") private String responsableMantenimiento;
